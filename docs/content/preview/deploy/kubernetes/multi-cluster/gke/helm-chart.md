...
To connect an external program, get the load balancer `EXTERNAL-IP` address of the `yb-tserver-service` services and connect using port 5433 for YSQL or port 9042 for YCQL, as follows:
